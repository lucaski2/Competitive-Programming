...
// if divisor count > 2 then not needed
// if size is 1
// coprime elements of size 1 work or multiples
// if size is 2
// handle separately, just other numbers == to that
