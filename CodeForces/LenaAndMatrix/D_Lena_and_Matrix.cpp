...
void solve(int tc)
{
  ...
  pair<int, int> a = {0, 0};
  pair<int, int> b = {n, m};
  pair<int, int> c = {0, INT_MAX};
  pair<int, int> d = {INT_MAX, 0};
  ...
  function<int(pair<int, int>, pair<int, int>)> f = [](pair<int, int> a, pair<int, int> b)
  {
  ...
  for (int i = 0; i < n; i++)
  {
    ...
    {
      pair<int, int> e = {i, j};
      vector<int> eles = {f(e, a), f(e, b), f(e, c), f(e, d)};
      int am = *max_element(all(eles));
      if (ans > am)
      {
        ans = am;
        best = e;
