...
// add the edges a - x and b - x
// for each guy u can only use one edge
// in a connecting component of set a, you can go through each element and see if it would be fine with set b
