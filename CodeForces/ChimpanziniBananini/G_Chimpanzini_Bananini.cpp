...
void solve(int tc)
{
  ...
  while (q--)
  {
    ...
    else
    {
      if (!reversed)
      {
        cur = cur + ele_sum - arr.back() * arr.size();
        rev_cur = rev_cur - ele_sum + arr.back() * arr.size();
      ...
      {
        cur = cur + ele_sum - arr.front() * arr.size();
        rev_cur = rev_cur - ele_sum + arr.front() * arr.size();
