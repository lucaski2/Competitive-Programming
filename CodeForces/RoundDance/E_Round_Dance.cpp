...
void solve(int tc)
{
  // maximum is number of connected components in fgraph
  // if it has an indegree if 1 then you can just discount it
  ...
  cout << min(comp, comp - open + 1) << ' ' << comp << endl;
