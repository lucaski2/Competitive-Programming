...
/*
if the most significant bit collides with anything it doesnt work
*/
...
void solve(int tc)
{
  ...
  int log = 30;
  vector<vector<vector<int>>> pref(log, vector<vector<int>>(n + 1, vector<int>(2)));
  vector<vector<vector<int>>> suff(log, vector<vector<int>>(n + 1, vector<int>(2)));
