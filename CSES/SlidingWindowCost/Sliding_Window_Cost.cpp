...
void solve(int tc)
{
  ...
  // case 1, new and old are less than median, below += new - old
  // case 2, both are more than median, above += new - old
  // case 3, new is greater, old is less, median shifts right by 1
  // case 4, old is less, new is greater, median shifts left by 1

  vector<int> a(n);
  for (int i = 0; i < n; i++)
    cin >> a[i];
  
  // only to make finding median easier
